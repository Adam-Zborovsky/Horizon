  ...
  Future<void> _performManualRefresh() async {
    ...
    try {
      ...
      while (!completed && attempts < 24) {
        ...
        if (briefing.createdAt != null &&
            briefing.createdAt!.isAfter(startTime)) {
          completed = true;
        }
      }
      ...
      if (completed) {
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Intelligence Updated'),
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFF1A1A1C), Color(0xFF080808)],
          ),
        ),
        child: Stack(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      AppTheme.goldAmber.withValues(alpha: 0.08),
                      AppTheme.goldAmber.withValues(alpha: 0.0),
                    ],
                  ),
                ),
              ),
            ...
            SafeArea(
              child: stocksAsync.when(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: AppTheme.goldAmber.withValues(
                            alpha: 0.1,
                          ),
                        ),
                        child: const Text(
                ...
                data: (allStocks) {
                  final watchlist = allStocks
                      .where((s) => s.source == StockSource.watchlist)
                      .toList();
                  final opportunities = allStocks
                      ...
                      return AnimatedBuilder(
                        ...
                        builder: (context, _) {
                          final bool isTrailing =
                              controller.side == IndicatorSide.bottom;
                          final dy = isTrailing
                              ? (controller.value * -indicatorHeight)
                              : 0.0;
                            ...
                            child: Padding(
                              ...
                              child: briefingAsync.when(
                                data: (briefing) {
                                  ...
                                  final categories = briefing.data.entries
                                      .toList();
                          ...
                          SliverToBoxAdapter(
                            child: Padding(
                              ...
                              child: _SectionLabel(
                                ...
                                color: AppTheme.goldAmber,
                                onTap: opportunities.isEmpty
                                    ? null
                                    : () => Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (_) =>
                                              WearOpportunitiesScreen(
            ...
            child: ListView(
              ...
              children: [
                ...
                if (stock.direction != null) ...[
                  ...
                  Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            (stock.direction!.toLowerCase() == 'long'
                                    ? AppTheme.goldAmber
                                    : AppTheme.softCrimson)
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          color: stock.direction!.toLowerCase() == 'long'
                              ? AppTheme.goldAmber
                              : AppTheme.softCrimson,
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
                ...
                if (stock.horizon != null ||
                    stock.potentialPriceAction != null) ...[
                  const SizedBox(height: 12),
                  const Text(
                    'PROJECTION',
                    style: TextStyle(
