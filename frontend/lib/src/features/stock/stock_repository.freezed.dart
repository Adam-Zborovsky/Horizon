...
mixin _$StockData {
 ...
 double get sentiment; String? get analysis;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,ticker,name,currentPrice,changePercent,const DeepCollectionEquality().hash(history),sentiment,analysis);

@override
String toString() {
  return 'StockData(ticker: $ticker, name: $name, currentPrice: $currentPrice, changePercent: $changePercent, history: $history, sentiment: $sentiment, analysis: $analysis)';
}
...
@useResult
$Res call({
 String ticker, String name, double currentPrice, double changePercent, List<double> history, double sentiment, String? analysis
});
...
/// Create a copy of StockData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? ticker = null,Object? name = null,Object? currentPrice = null,Object? changePercent = null,Object? history = null,Object? sentiment = null,Object? analysis = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ticker,  String name,  double currentPrice,  double changePercent,  List<double> history,  double sentiment,  String? analysis)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StockData() when $default != null:
return $default(_that.ticker,_that.name,_that.currentPrice,_that.changePercent,_that.history,_that.sentiment,_that.analysis);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ticker,  String name,  double currentPrice,  double changePercent,  List<double> history,  double sentiment,  String? analysis)  $default,) {final _that = this;
switch (_that) {
case _StockData():
return $default(_that.ticker,_that.name,_that.currentPrice,_that.changePercent,_that.history,_that.sentiment,_that.analysis);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ticker,  String name,  double currentPrice,  double changePercent,  List<double> history,  double sentiment,  String? analysis)?  $default,) {final _that = this;
switch (_that) {
case _StockData() when $default != null:
return $default(_that.ticker,_that.name,_that.currentPrice,_that.changePercent,_that.history,_that.sentiment,_that.analysis);case _:
  return null;
...
class _StockData implements StockData {
  const _StockData({required this.ticker, required this.name, required this.currentPrice, required this.changePercent, required final  List<double> history, required this.sentiment, this.analysis}): _history = history;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,ticker,name,currentPrice,changePercent,const DeepCollectionEquality().hash(_history),sentiment,analysis);
...
/// Create a copy of StockData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? ticker = null,Object? name = null,Object? currentPrice = null,Object? changePercent = null,Object? history = null,Object? sentiment = null,Object? analysis = freezed,}) {
